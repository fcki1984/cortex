...
AI 的记忆在对话结束那一刻就消失了。你今天说的话，它明天一概不知。

**Cortex 解决这个问题。** 它是一个独立运行的记忆服务，默默学习你是谁、你在乎什么、你怎么工作。下次对话时，它会自动回忆起恰好需要的上下文。

```
你：     "我叫小明，做后端开发，Rust 比 Go 顺手。"
Cortex:   → 提取 [身份] 小明，后端开发
          → 提取 [偏好] 偏好 Rust 而非 Go

          ... 三周后，新对话 ...

你：     "这个新服务用什么语言比较好？"
AI：     "你之前提到后端开发更偏好 Rust。"
```
